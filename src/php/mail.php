...
$mail->Host     = "smtp.serralheriarodrigues.com"; 				 	// SMTP server - or mail.yourdomain.com
$mail->SMTPAuth = true;    								 	// turn on SMTP authentication
$mail->Username = "lucio@rodriguessi.com.br"; 			    // Noreply address on your sevrer
$mail->Password = "lucio1981";						// Noreply's Password

$mail->From     = "lucio@rodriguessi.com.br";					// Noreply address on your sevrer - Again
$mail->AddAddress("lucio@rodriguessi.com.br");			  	// Your Adress Here
...
"<script>console.log( 'Debug Objects: saída ' );</script>";
